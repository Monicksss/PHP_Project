...
?>
<div class="modal fade" id="orderSuccessModal" data-bs-backdrops="static" data-bs-keyboard="false"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="text-align:center;" colspan="2">
                                                        ...
                                                        <p style="font-size:16px; line-height:24px; margin:2px; padding:0;">#555, 1st street, 3rd cross,banglore,india</p>
                                                ...
                                                <tr> 
                                                 ...
                                                 <h4 style="font-size:20px; line-height:30px; margin:0px; padding:0;">Invoice Details</h4>
                                                        ...
                                                        <p style="font-size:14px; line-height:20px; margin:0px; padding:0;">Address: 1st main road,Banglore,India</p>
